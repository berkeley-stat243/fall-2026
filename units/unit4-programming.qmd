...
So calling `transform(data)` does the transformation based on the parameters stored in the closure (the namespace of the enclosing scope) of the function `transform`.
