...
## Core Python functions for text files
...
# 5. Interacting with the operating system and external code and configuring Python 
...
# 8. Programming paradigms: object-oriented and functional programming
