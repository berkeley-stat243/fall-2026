...
(**) It's fine, and actually recommended, to use the distributed scheduler on one machine, such as
    ...
    tutorial), smarter task scheduling, and better handling of when copies need to be made. In
...
Details will depend on how you install Python, numpy, and scipy. More details on figuring out what BLAS is being used and how to install a fast threaded BLAS on your own computer are [here](https://computing.stat.berkeley.edu/kb/linear-algebra-using-blas).
