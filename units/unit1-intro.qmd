...
machines, often by [remotely logging in to a UNIX-based server](https://computing.stat.berkeley.edu/access/ssh).
...
the material in last week's [Computing Skills Workshop](https://computing.stat.berkeley.edu/compute-skills-2026/units/intro-computing.html). We'll do a
...
please work through the tutorial by the end of Friday August 28 and (optionally) attend section on
Friday August 28 to work on the problems at the end of the tutorial and
...
we'll discuss in Unit 2 on shell scripting), see [this Software
...
# 5. Knowing your context

Here are the key things to be aware of when you are in the shell or executing code:

 - What machine am I on?
 - What user am I?
 - What is the current working directory?
 - What git branch am I in (if the working directory is in a Git repo)?
 - What Conda environment am I in (if relevant)?

# 6. (BACKGROUND) Editors
...
-   *VS Code* is an integrated development environment (IDE) that has a powerful code editor that is customized to work with
    ...
    - I will use/demo VS Code (+ GitHub Copilot) in class some.
...
### Emacs keystroke sequence shortcuts (aka, *key bindings*).
