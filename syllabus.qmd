...
Python at an advanced level (primarily in Stat 243A), these are not courses about learning Python. Rather the focus of the course is computing for statistics and data science more generally, using Python to illustrate the concepts. 
 - These are not courses that will cover specific statistical/machine learning/data analysis methods. 
...
In general, the [material in the Statistics Department  computational skills workshop](https://computing.stat.berkeley.edu/compute-skills-2026) is a
...
[Python material in our computing skills workshop](https://computing.stat.berkeley.edu/compute-skills-2026/units/intro-python.html). If you don't have that background
...
Key websites for the courses are (see button links on [main page](../index):
...
-   Pensive/Gradescope for assignments (also linked from bCourses)
...
questions so that either Reece or I can respond and so that everyone
...
If you're enrolled in the class you should be a member of the Ed Discussion group and be able to access it. If you're auditing or not yet enrolled and would like access, make sure to fill out the [course survey](https://forms.gle/7newMx42Jg1TmKUK9) and I will add you. 
...
Most work for the courses can be done on your laptop. Later in Stat 243A
...
See the "how tos" in the left sidebar for tips on software installation and access to a UNIX shell, which you'll need to be able to do by the end of the first week of class for 243A.
...
experience), I encourage you to contribute with your perspective. In
...
dates are Monday October 12 (243A) and Monday November 23 (243B).
...
1-2 weeks, in-section quizzes on the assignments, one mini-exam (Oct. 12 and Nov. 23)
...
Note that "full credit" for the in-class Google forms will take into account that you may be absent occasionally and doesn't require that you have filled out 100% of the forms.

Grades will generally be As and Bs. An A involves doing all the work,
getting full credit on most of the problem sets and quizzes and doing well on the mini-exam.
...
I am not going to police your use of AI. You may use ChatBots and AI-assisted coding tools, but you should be very careful about relying substantially on AI (see comments below). You are also welcome to collaborate with others in the class. However, if you simply turn in answers that are mainly copies of what an AI tool (or your classmate) told you, you are probably not learning the material, and this is likely to be reflected in your performance on the problem set quizzes (and on the mini-exams, albeit less directly).  
...
You should only take advantage of the retake option once or twice, and you should should not do so simply for missing a point or two (even if you feel that the missing point(s) did not accurately reflect your understanding).
...
2.  Problem set submission consists of **both** of the following:
    ...
    1.  A PDF submitted electronically through Pensive/Gradescope, **by the
    ...
    when the PDF is submitted to Pensive/Gradescope.
...
Late problem set submissions will be accepted up until the late deadline listed in Pensive/Gradescope,
after which they won't be accepted or graded. If you regularly submit late problem sets, that will be
accounted for in the class participation portion of your grade. Also, even if you need to submit late,
you should make sure you've done enough by the time of the associated quiz to have
understood the material and to be able to do well on the quizzes.
